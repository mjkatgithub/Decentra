...
const messages: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    'settings.spacePermManageRoles': 'Manage roles',
    'settings.spacePermRedact': 'Delete others\' messages',
    'settings.spacePermReorder': 'Reorder channels',
  ...
  de: {
    ...
    'settings.spaceRolesHint':
      'Rollen mit eigenem Namen, Farbe und Rechten anlegen.',
    'settings.spaceRolesDragHint':
    ...
    'settings.spacePermManageRoles': 'Rollen verwalten',
    'settings.spacePermRedact': 'Fremde Nachrichten loeschen',
    'settings.spacePermReorder': 'Kanaele sortieren',
