...
const messages: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    'layout.spaceUnreadAria': 'Unread messages in space {name}',
    'layout.spaceMentionUnreadAria': 'Mentioned in space {name}',
  ...
  de: {
    ...
    'layout.spaceUnreadAria': 'Ungelesene Nachrichten in Space {name}',
    'layout.spaceMentionUnreadAria': 'Erwähnung in Space {name}',
